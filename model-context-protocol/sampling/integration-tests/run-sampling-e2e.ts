...
const INTEGRATION_TESTS_DIR = dirname(fileURLToPath(import.meta.url));
const SAMPLE_DIR = resolve(INTEGRATION_TESTS_DIR, "..");
const CLIENT_DIR = resolve(SAMPLE_DIR, "mcp-sampling-client");
const SERVER_DIR = resolve(SAMPLE_DIR, "mcp-sampling-server");
