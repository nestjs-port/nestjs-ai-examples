...
import { BraveDockerAgentsGatewayRunner } from "./brave-docker-agents-gateway.runner.js";
...
@Module({
  imports: [
    ...
    McpClientModule.forRoot({
      name: "mcp-brave-docker-agents-gateway",
      version: "0.0.1",
      streamableHttp: {
        connections: {
          gateway: {
  ...
  providers: [BraveDockerAgentsGatewayRunner],
})
